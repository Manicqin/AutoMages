...
#ifndef OISEXPORTS_H_
#define OISEXPORTS_H_
...
inline bool buttonDown( int buttons , OIS::MouseButtonID button )
{
	return ((buttons & ( 1L << button )) == 0) ? false : true;
}


BOOST_PYTHON_MODULE(OISExports)
{
	boost::python::def("buttonDown",&buttonDown);

	boost::python::class_<OIS::Axis>("Axis")
		.def_readonly("abs",&OIS::Axis::abs)
		.def_readonly("rel",&OIS::Axis::rel);

	boost::python::class_<OIS::MouseState>("MouseState")
			.def_readonly("X",&OIS::MouseState::X)
			.def_readonly("Y",&OIS::MouseState::Y)
			.def_readonly("Z",&OIS::MouseState::Z)
			.def_readonly("width",&OIS::MouseState::width)
			.def_readonly("height",&OIS::MouseState::height)
			.def_readonly("buttons",&OIS::MouseState::buttons)
			.def("buttonDown",&OIS::MouseState::buttonDown);

	boost::python::enum_<OIS::MouseButtonID>("MouseButtonID")
	...
	boost::python::class_<OIS::KeyEvent>("KeyEvent",boost::python::no_init)
		.def_readonly("key",&OIS::KeyEvent::key)
		.def_readonly("text",&OIS::KeyEvent::text);

	boost::python::enum_<OIS::KeyCode>("KeyCode")
	...
	.value("KC_NUMPAD9",OIS::KC_NUMPAD8)
